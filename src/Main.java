...
public class Main {
  ...
  // The time complexity is:
  // O(n) where n = the number of letters in the word
  ...
  // The time complexity is:
  // O(n) where n = the length of the bannedPasswords array
  ...
  // of the array
  // O(n^2) where n = the length of the nums array
  ...
  // The time complexity is:
  // O(n) where n = the size of the arr ArrayList
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(n^2) where n = the length of the wordsA and wordsB arrays
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(n) where n = the length of the wordsA and wordsB arrays
  ...
  // O(n) where n = the length of names and emails arrays.
  ...
  // O(a * b) where a is the wordSet and b is the wordList
  ...
  // O(a + b) where a = wordSet and b = wordList
  ...
  // HashMap (key: stock ticker, value: current price)
  ...
  // What would be a good choice of data structure?
  // A List (eg. ArrayList implementation)
  ...
  // What would be a good choice of data structure?
  // ArrayList to maintain order of recent search queries
}